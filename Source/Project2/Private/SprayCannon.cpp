...
ASprayCannon::ASprayCannon()
{
	...
	Mesh=CreateDefaultSubobject<UStaticMeshComponent>("Cash");
...
void ASprayCannon::SprayShoot(int& AmmoSpray)
{
	...
	case ESprayCannonType::FireProjectiles:
		...
		//AProjectile
		GetWorld()->SpawnActor<ABaseProjectile>(SprayProjectileClass, ProjectileSpawnPoints->GetComponentLocation(), ProjectileSpawnPoints->GetComponentRotation());
		AmmoSpray--;
