...
void AEnemyTank_Pawn::OnConstruction(const FTransform& Transform)
{
	Super::OnConstruction(Transform);

	GEngine->AddOnScreenDebugMessage(-1, 10, FColor::Red, FString::Printf(TEXT("TANK SPAWNED %d"), Number));
}
...
{
	GEngine->AddOnScreenDebugMessage(83235042, 3, FColor::White,FString::Printf(TEXT("HP ENEMY: %f"), CurrentHealth));
}
